...
#    'DELL': 'Dell', # Unlisted
    ...
    'GSK': 'GlaxoSmithKline',
    'PFE': 'Pfizer',
    'SNY': 'Sanofi-Aventis', # Started 2002
    'NVS': 'Novartis',
    'KMB': 'Kimberly-Clark',
    'R': 'Ryder',
    'GD': 'General Dynamics',
...
def main():
    # 2002 has only half of Sanofi-Aventis
    for year in range(2003, 2016):
        print("Year %d-%d" % (year, (year+2)))
        d1 = datetime.datetime(year, 1, 1)
        d2 = datetime.datetime(year+3, 1, 1)
